...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['aksi'])) {
    ...
    if ($aksi === 'tambah') {
        ...
        $sql = "INSERT INTO audit_fasilitas_apd
    ...
    if ($aksi === 'update') {
        ...
        $sql = "UPDATE audit_fasilitas_apd SET
    ...
    if ($aksi === 'hapus') {
        ...
        $sql = "DELETE FROM audit_fasilitas_apd WHERE id_ruang=? AND tanggal=?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ss", $id_ruang, $tanggal);
        $stmt->execute();

        header("Location: audit_fasilitas_apd.php");
        exit;
    }
}
...
// === HITUNG TOTAL DATA ===
$sqlCount = "SELECT COUNT(*) AS total FROM audit_fasilitas_apd ".($awalForm&&$akhirForm?"WHERE tanggal BETWEEN ? AND ?":"WHERE 1=0");
...
<head>
  <meta charset="UTF-8">
  <title>Audit Fasilitas APD</title>
    ...
    <div class="container-fluid mt-4">
      <div class="card shadow">
        ...
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
          <h5 class="mb-0 text-uppercase flex-grow-1 text-center">Audit Fasilitas APD</h5>
            ...
            <table class="table table-striped table-bordered table-master_audit align-middle">
              <thead class="table-dark text-center">
                <tr>
                  ...
                  <th>ID Ruang</th>
                  <th>Ruang/Unit</th>
                  <th>1. Ada Kebijakan Pembuangan Limbah Rumah Sakit</th>
                  <th>2. Tersedia Masker Di Ruang Perawatan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</th>
                  <th>3. Tersedia Sarung Tangan On Steril & Steril Di Ruangan, Intensif Dan Ruang Tindakan Sesuai Kebutuhan</th>
                  <th>4. Tersedia Topi Di Ruangan Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</th>
                  <th>5. Tersedia Gaun Di Ruangan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</th>
                  <th>6. Tersedia Sepatu Boot (Sepatu Penutup)</th>
                  <th>Ttl. Nilai (%)</th>
                  <th>Aksi</th>
                </tr>
              </thead>
      ...
      <div class="modal-content">
        <form method="post" action="">
          ...
          <div class="modal-header bg-success text-white">
            <h5 class="modal-title">Tambah Audit Fasilitas APD</h5>
          ...
          <div class="modal-body">
            ...
            <div class="item-audit">
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">1. Ada Kebijakan Pembuangan Limbah Rumah Sakit</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">2. Tersedia Masker Di Ruang Perawatan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">3. Tersedia Sarung Tangan On Steril & Steril Di Ruangan, Intensif Dan Ruang Tindakan Sesuai Kebutuhan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">4. Tersedia Topi Di Ruangan Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">5. Tersedia Gaun Di Ruangan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">6. Tersedia Sepatu Boot (Sepatu Penutup)</label>
      ...
      <div class="modal-content">
        <form method="post" action="">
          ...
          <div class="modal-header bg-warning text-dark">
            <h5 class="modal-title">Edit Audit Fasilitas APD</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
          </div>
          <div class="modal-body">
            <!-- Tanggal Audit & Ruang -->
            ...
            <div class="item-audit">
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">3. Tersedia Sarung Tangan Di Ruang Perawatan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">4. Tersedia Topi Di Ruang Perawatan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">5. Tersedia Gaun Di Ruang Perawatan, Intensif, Ruang Tindakan Sesuai Dengan Kebutuhan</label>
