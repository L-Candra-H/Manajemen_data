...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['aksi'])) {
    ...
    if ($aksi === 'tambah') {
        $sql = "INSERT INTO audit_pengelolaan_linen_kotor
                (tanggal, id_ruang,
    ...
    if ($aksi === 'update') {
        ...
        $sql = "UPDATE audit_pengelolaan_linen_kotor SET
                tanggal=?, id_ruang=?,
                audit1=?, audit2=?, audit3=?, audit4=?,
                audit5=?, audit6=?, audit7=?, audit8=?
                WHERE id_ruang=? AND tanggal=?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ssssssssssss", $tanggal, $id_ruang, $audit1, $audit2, $audit3, $audit4, $audit5, $audit6, $audit7, $audit8, $old_id_ruang, $old_tanggal);
        $stmt->execute();
    }
    ...
    if ($aksi === 'hapus') {
        ...
        $sql = "DELETE FROM audit_pengelolaan_linen_kotor WHERE id_ruang=? AND tanggal=?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ss", $id_ruang, $tanggal);
        $stmt->execute();
        header("Location: audit_pengelolaan_linen_kotor.php");
        exit;
    }
}
...
$sqlData = "SELECT a.*, r.nama_ruang
            FROM audit_pengelolaan_linen_kotor a 
...
// === HITUNG TOTAL DATA ===
$sqlCount = "SELECT COUNT(*) AS total FROM audit_pengelolaan_linen_kotor " . ($awalForm && $akhirForm ? "WHERE tanggal BETWEEN ? AND ?" : "WHERE 1=0");
...
$sqlRekap = "SELECT
    ...
    COUNT(*) AS total
  FROM audit_pengelolaan_linen_kotor
...
$totalYa = $rekap['audit1_ya'] + $rekap['audit2_ya'] + $rekap['audit3_ya'] +
           ...
           $rekap['audit7_ya'] + $rekap['audit8_ya'];
...
<head>
  <meta charset="UTF-8">
  <title>Audit Pengelolaan Linen Kotor</title>
    ...
    <div class="container-fluid mt-4">
      <div class="card shadow">
        ...
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
          <h5 class="mb-0 text-uppercase flex-grow-1 text-center">Audit Pengelolaan Linen Kotor</h5>
            ...
            <table class="table table-striped table-bordered table-master_audit align-middle">
              <thead class="table-dark text-center">
                <tr>
                  ...
                  <th>ID Ruang</th>
                  <th>Ruang/Unit</th>
                  <th>1. Petugas Ruangan Segera Mengambil Linen Kotor Untuk Dimasukkan Ke Dalam Bak Setelah Pasien Pulang</th>
                  <th>2. Petugas Laundry Mengambil Linen Kotor Untuk Dimasukkan Ke Dalam Bak Linen Kotor Dengan Cara Yang Benar</th>
                  <th>3. Petugas Ruangan Menempatkan Linen Kotor Sesuai Dengan Wadah Yang Ditentukan</th>
                  <th>4. Petugas Memasukkan Linen Kotor Ke Dalam Bak Linen Kotor Dengan Benar</th>
                  <th>5. Fasilitas Bak Penampung Linen Kotor Tersedia Dengan Baik Ruangan</th>
                  <th>6. Plastik Untuk Penampung Linen Kotor Tersedia Dengan Baik di Ruangan</th>
                  <th>7. Petugas Linen Laundry Mengambil Linen Kotor Sesuai Jadwal</th>
                  <th>8. Sudah Tersedia Troli Khusus Untuk Linen Infeksius Dan Non Infeksius</th>
                  <th>Ttl. Nilai (%)</th>
                  <th>Aksi</th>
                </tr>
              </thead>
      ...
      <div class="modal-content">
        <form method="post" action="">
          ...
          <div class="modal-header bg-success text-white">
            <h5 class="modal-title">Tambah Audit Pengelolaan Linen Kotor</h5>
          ...
          <div class="modal-body">
            ...
            <div class="item-audit">
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">1. Petugas Ruangan Segera Mengambil Linen Kotor Untuk Dimasukkan Ke Dalam Bak Setelah Pasien Pulang</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">2. Petugas Laundry Mengambil Linen Kotor Untuk Dimasukkan Ke Dalam Bak Linen Kotor Dengan Cara Yang Benar</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">3. Petugas Ruangan Menempatkan Linen Kotor Sesuai Dengan Wadah Yang Ditentukan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">4. Petugas Memasukkan Linen Kotor Ke Dalam Bak Linen Kotor Dengan Benar</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">5. Fasilitas Bak Penampung Linen Kotor Tersedia Dengan Baik Ruangan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">6. Plastik Untuk Penampung Linen Kotor Tersedia Dengan Baik di Ruangan</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">7. Petugas Linen Laundry Mengambil Linen Kotor Sesuai Jadwal</label>
              ...
              <div class="col-md-12 d-flex align-items-center gap-3">
                <label class="flex-grow-1">8. Sudah Tersedia Troli Khusus Untuk Linen Infeksius Dan Non Infeksius</label>
      ...
      <div class="modal-content">
        <form method="post" action="">
          ...
          <div class="modal-header bg-warning text-dark">
            <h5 class="modal-title">Edit Audit Pengelolaan Linen Kotor</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
          </div>
          <div class="modal-body">
            <div class="d-flex mb-3 align-items-center gap-3 flex-wrap">
