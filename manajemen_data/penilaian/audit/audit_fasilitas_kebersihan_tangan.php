...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['aksi'])) {
    ...
    if ($aksi === 'tambah') {
        ...
        $sql = "INSERT INTO audit_fasilitas_kebersihan_tangan
    ...
    if ($aksi === 'update') {
        ...
        $sql = "UPDATE audit_fasilitas_kebersihan_tangan SET
                    tanggal=?, id_ruang=?, audit1=?, audit2=?, 
                    audit3=?, audit4=?, audit5=?, audit6=?, 
                    audit7=?, audit8=?, audit9=?
                WHERE id_ruang=? AND tanggal=?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssssssssss", $tanggal, $id_ruang, 
                          $audit1, $audit2, $audit3, $audit4, $audit5, $audit6, $audit7, $audit8, $audit9, $old_id_ruang, $old_tanggal);
        $stmt->execute();
    }
    ...
    if ($aksi === 'hapus') {
        ...
        $sql = "DELETE FROM audit_fasilitas_kebersihan_tangan WHERE id_ruang=? AND tanggal=?";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("ss", $id_ruang, $tanggal);
        $stmt->execute();

        header("Location: audit_fasilitas_kebersihan_tangan.php");
        exit;
    }
}
...
$sqlData = "SELECT a.*, r.nama_ruang
            FROM audit_fasilitas_kebersihan_tangan a
...
// === HITUNG TOTAL DATA ===
$sqlCount = "SELECT COUNT(*) AS total FROM audit_fasilitas_kebersihan_tangan ".($awalForm&&$akhirForm?"WHERE tanggal BETWEEN ? AND ?":"WHERE 1=0");
...
$sqlRekap = "SELECT
    ...
    COUNT(*) AS total
    FROM audit_fasilitas_kebersihan_tangan
...
// === HITUNG TTL ===
$totalYa = $rekap['a1_ya']+$rekap['a2_ya']+$rekap['a3_ya']+$rekap['a4_ya']+$rekap['a5_ya']+$rekap['a6_ya']+$rekap['a7_ya']+$rekap['a8_ya']+$rekap['a9_ya'];
$totalTidak = $rekap['a1_tidak']+$rekap['a2_tidak']+$rekap['a3_tidak']+$rekap['a4_tidak']+$rekap['a5_tidak']+$rekap['a6_tidak']+$rekap['a7_tidak']+$rekap['a8_tidak']+$rekap['a9_tidak'];
$totalItem = $rekap['total']*9;
...
<head>
  <meta charset="UTF-8">
  <title>Audit Fasilitas Kebersihan Tangan</title>
    ...
    <div class="container-fluid mt-4">
      <div class="card shadow">
        ...
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
          <h5 class="mb-0 text-uppercase flex-grow-1 text-center">Audit Fasilitas Kebersihan Tangan</h5>
            ...
            <table class="table table-striped table-bordered table-master_audit align-middle">
              <thead class="table-dark text-center">
                <tr>
                  ...
                  <th>ID Ruang</th>
                  <th>Ruang/Unit</th>
                  <th>1. Tersedia Wastafel Dan Berfungsi Dengan Baik</th>
                  <th>2. Tersedia Sabun Cair Di Setiap Wastafel</th>
                  <th>3. Tersedia Tisu Kertas Di Setiap Wastafel</th>
                  <th>4. Tersedia Cairan Antiseptik Untuk Cuci Tangan Di Wastafel</th>
                  <th>5. Wastafel Bebas Dari Peralatan Yang Tidak Tepat</th>
                  <th>6. Fasilitas Tempat Cuci Tangan Bersih</th>
                  <th>7. Ada Tempat Sampah Di Bawah Wastafel</th>
                  <th>8. Tersedia Handrub Di Setiap Ruangan</th>
                  <th>9. Tersedia Poster Kebersihan Tangan</th>
                  <th>Ttl. Nilai (%)</th>
                  <th>Aksi</th>
                </tr>
              </thead>
              <tbody>
                <?php if($result->num_rows == 0): ?>
                  <tr>
                    <td colspan="14" class="text-center text-muted">Silakan pilih periode untuk menampilkan data</td>
                  </tr>
                <?php else: ?>
      ...
      <div class="modal-content">
        <form method="post" action="">
          ...
          <div class="modal-header bg-success text-white">
            <h5 class="modal-title">Tambah Audit Fasilitas Kebersihan Tangan</h5>
          ...
          <div class="modal-body">
            ...
            <div class="row g-3 mb-2">
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">1. Tersedia Wastafel Dan Berfungsi Dengan Baik</label>
              ...
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">2. Tersedia Sabun Cair Di Setiap Wastafel</label>
            ...
            <div class="row g-3 mb-2">
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">3. Tersedia Tisu Kertas Di Setiap Wastafel</label>
              ...
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">4. Tersedia Cairan Antiseptik Untuk Cuci Tangan Di Wastafel</label>
            ...
            <div class="row g-3 mb-2">
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">5. Wastafel Bebas Dari Peralatan Yang Tidak Tepat</label>
              ...
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">6. Fasilitas Tempat Cuci Tangan Bersih</label>
            ...
            <div class="row g-3 mb-2">
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">7. Ada Tempat Sampah Di Bawah Wastafel</label>
              ...
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">8. Tersedia Handrub Di Setiap Ruangan</label>
            ...
            <div class="row g-3 mb-2">
              <div class="col-md-6 d-flex align-items-center gap-3">
                <label class="flex-grow-1">9. Tersedia Poster Kebersihan Tangan</label>
      ...
      <div class="modal-content">
        <form method="post" action="">
          ...
          <div class="modal-header bg-warning text-dark">
            <h5 class="modal-title">Edit Audit Fasilitas Kebersihan Tangan</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
          </div>
          <div class="modal-body">
            <!-- Tanggal Audit & Ruang -->
