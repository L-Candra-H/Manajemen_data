...
if ($filter === '') {
    ...
    $sql = "SELECT kode, kategori, nama_berkas, no_urut FROM master_berkas_pegawai 
            WHERE kategori='" . mysqli_real_escape_string($conn, $filter) . "' 
            ORDER BY no_urut LIMIT $limit OFFSET $offset";
}
    ...
    <div class="modal-dialog">
      <form action="" method="post" class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3"><label class="form-label">Nama Berkas</label><input type="text" name="nama_berkas" class="form-control" required></div>
          <div class="mb-3"><label class="form-label">No. Urut</label><input type="number" name="no_urut" class="form-control" required></div>
          <div class="mb-3">
