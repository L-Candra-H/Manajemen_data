...
// ambil bagian_kry dari tabel set_warung
$stmt = $conn->prepare("SELECT bagian_kry FROM set_warung WHERE tahun=? AND bulan=?");
...
<head>
  <meta charset="UTF-8">
  <title>Detail Pembagian Warung</title>
  ...
  <div class="card shadow">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
      <h5 class="mb-0 text-uppercase flex-grow-1 text-center">
        DETAIL PEMBAGIAN WARUNG - <?= htmlspecialchars($tahun) . " " . $bulanArr[(int)$bulan] ?>
      </h5>
      <div class="d-flex gap-2">
        <button class="btn btn-light btn-sm" data-bs-toggle="modal" data-bs-target="#modalTambah">➕ Tambah Penerima</button>
        <a href="pendapatan_warung.php" class="btn btn-secondary btn-sm">⬅️ Kembali</a>
      </div>
    </div>
