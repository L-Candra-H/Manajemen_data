          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="jnj_jabatan" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($jnj_jabatan)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="kode_kelompok" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($kelompok)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="bidang" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($bidang)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="kode_resiko" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($resiko)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="stts_wp" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($stts_wp)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="stts_kerja" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($stts_kerja)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <select name="bpd" class="form-select">
                ...
                <?php while ($row = mysqli_fetch_assoc($bank)) : ?>
            ...
            <div class="col-md-6 mb-3">
              ...
              <small class="form-text text-muted">
                Isi dgn "-"  jk ingin wajib masuk 1 bulan-hari libur<br>
